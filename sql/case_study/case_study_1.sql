...
select * from nhan_vien where ho_ten regexp '([A-Za-z//s]+//sH[a-z]+)'and length(ho_ten)<=15;
-- 3.	Hiển thị thông tin của tất cả khách hàng có độ tuổi từ 18 đến 50 tuổi và có địa chỉ ở “Đà Nẵng” hoặc “Quảng Trị”.
select * from khach_hang where year(ngay_sinh)<=2004 and year(ngay_sinh)>=1972 and (dia_chi like "%Quảng Trị" or dia_chi like "%Đà Nẵng");
-- 4.	Đếm xem tương ứng với mỗi khách hàng đã từng đặt phòng bao nhiêu lần.
--  Kết quả hiển thị được sắp xếp tăng dần theo số lần đặt phòng của khách hàng. 
--  Chỉ đếm những khách hàng nào có Tên loại khách hàng là “Diamond”.
select  h.ma_khach_hang,count(h.ma_khach_hang) as so_luong from loai_khach s
...
group by kh.ho_ten;
-- c2
select kh.ho_ten from loai_khach lk join khach_hang kh on lk.ma_loai_khach=kh.ma_loai_khach
union
select kh.ho_ten from khach_hang kh join loai_khach lk on kh.ma_loai_khach=lk.ma_loai_khach;
-- c3  
select distinct kh.ho_ten from loai_khach lk join khach_hang kh on lk.ma_loai_khach=kh.ma_loai_khach;
